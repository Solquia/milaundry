...
import { Button, Card, Loading, Screen, Subtle, colors, space } from '@/components/ui-kit';
import { useAuth } from '@/lib/auth';
import { signOutPrompt } from '@/lib/domain/confirm-prompts';
import { canManageShop, describeShopAccess } from '@/lib/domain/merchant-access';
...
const styles = {
  shopName: { fontSize: 22, fontWeight: '700' as const, color: colors.text },
